...
/**
 * @title Meluri AI NFT (EVM)
 * @dev Universal NFT that can be minted from any EVM chain and transferred cross-chain
 * Based on ZetaChain's official Universal NFT standard for EVM chains
 */
